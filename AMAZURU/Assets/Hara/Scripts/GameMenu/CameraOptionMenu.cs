...
public class CameraOptionMenu : MyAnimation
{
    ...
    [SerializeField, Tooltip("現在の設定表示")] private TextMeshProUGUI nowSetting = null;
    [SerializeField, Tooltip("Configデータ")] private Config config = null;

    /// <summary>
    /// カメラオプションを開くフラグ
    /// </summary>
    public bool IsOpenPause { set; get; } = false;

    /// <summary>
    /// カメラの速度設定の情報
    /// </summary>
    public CameraSpeed SpeedType { private set; get; } = CameraSpeed.Normal;
    ...
    void Update()
    {
        ...
        SelectAnimation();
        SelectAction();
        if (ControllerInput.Instance.buttonDown.cross)
        {
